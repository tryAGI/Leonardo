...
namespace Leonardo
{
    public partial class ElementsClient
    {
        ...
        private static readonly global::Leonardo.EndPointSecurityRequirement s_GetElementByIdSecurityRequirement0 =
        ...
        private static readonly global::Leonardo.EndPointSecurityRequirement[] s_GetElementByIdSecurityRequirements =
            new global::Leonardo.EndPointSecurityRequirement[]
            {                s_GetElementByIdSecurityRequirement0,
            };
        partial void PrepareGetElementByIdArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int id);
        partial void PrepareGetElementByIdRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int id);
        partial void ProcessGetElementByIdResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetElementByIdResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Leonardo.GetElementByIdResponse> GetElementByIdAsync(
            int id,
            global::Leonardo.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetElementByIdAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Leonardo.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Leonardo.AutoSDKHttpResponse<global::Leonardo.GetElementByIdResponse>> GetElementByIdAsResponseAsync(
            int id,
            global::Leonardo.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetElementByIdArguments(
            ...
            var __authorizations = global::Leonardo.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetElementByIdSecurityRequirements,
                operationName: "GetElementByIdAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Leonardo.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Leonardo.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetElementByIdAsync",
                ...
                else
                {
                    await global::Leonardo.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetElementByIdResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Leonardo.GetElementByIdResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Leonardo.AutoSDKHttpResponse<global::Leonardo.GetElementByIdResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Leonardo.GetElementByIdResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
