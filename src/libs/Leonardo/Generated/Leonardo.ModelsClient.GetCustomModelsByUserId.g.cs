...
namespace Leonardo
{
    public partial class ModelsClient
    {
        ...
        private static readonly global::Leonardo.EndPointSecurityRequirement s_GetCustomModelsByUserIdSecurityRequirement0 =
        ...
        private static readonly global::Leonardo.EndPointSecurityRequirement[] s_GetCustomModelsByUserIdSecurityRequirements =
            new global::Leonardo.EndPointSecurityRequirement[]
            {                s_GetCustomModelsByUserIdSecurityRequirement0,
            };
        partial void PrepareGetCustomModelsByUserIdArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string userId);
        partial void PrepareGetCustomModelsByUserIdRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string userId);
        partial void ProcessGetCustomModelsByUserIdResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetCustomModelsByUserIdResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Leonardo.GetCustomModelsByUserIdResponse> GetCustomModelsByUserIdAsync(
            string userId,
            global::Leonardo.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetCustomModelsByUserIdAsResponseAsync(
                userId: userId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Leonardo.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Leonardo.AutoSDKHttpResponse<global::Leonardo.GetCustomModelsByUserIdResponse>> GetCustomModelsByUserIdAsResponseAsync(
            string userId,
            global::Leonardo.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetCustomModelsByUserIdArguments(
            ...
            var __authorizations = global::Leonardo.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetCustomModelsByUserIdSecurityRequirements,
                operationName: "GetCustomModelsByUserIdAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Leonardo.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Leonardo.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetCustomModelsByUserIdAsync",
                                pathTemplate: "$\"/models/user/{userId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetCustomModelsByUserIdResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Leonardo.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetCustomModelsByUserIdResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Leonardo.GetCustomModelsByUserIdResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Leonardo.AutoSDKHttpResponse<global::Leonardo.GetCustomModelsByUserIdResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Leonardo.GetCustomModelsByUserIdResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
