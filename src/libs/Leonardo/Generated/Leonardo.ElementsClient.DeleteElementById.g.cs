...
namespace Leonardo
{
    public partial class ElementsClient
    {
        ...
        private static readonly global::Leonardo.EndPointSecurityRequirement s_DeleteElementByIdSecurityRequirement0 =
        ...
        private static readonly global::Leonardo.EndPointSecurityRequirement[] s_DeleteElementByIdSecurityRequirements =
            new global::Leonardo.EndPointSecurityRequirement[]
            {                s_DeleteElementByIdSecurityRequirement0,
            };
        partial void PrepareDeleteElementByIdArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int id);
        partial void PrepareDeleteElementByIdRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int id);
        partial void ProcessDeleteElementByIdResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDeleteElementByIdResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Leonardo.DeleteElementByIdResponse> DeleteElementByIdAsync(
            int id,
            global::Leonardo.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await DeleteElementByIdAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Leonardo.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Leonardo.AutoSDKHttpResponse<global::Leonardo.DeleteElementByIdResponse>> DeleteElementByIdAsResponseAsync(
            int id,
            global::Leonardo.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDeleteElementByIdArguments(
            ...
            var __authorizations = global::Leonardo.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_DeleteElementByIdSecurityRequirements,
                operationName: "DeleteElementByIdAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDeleteElementByIdRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Leonardo.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Leonardo.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "DeleteElementByIdAsync",
                                pathTemplate: "$\"/elements/{id}\"",
                                httpMethod: "DELETE",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDeleteElementByIdResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Leonardo.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDeleteElementByIdResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Leonardo.DeleteElementByIdResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Leonardo.AutoSDKHttpResponse<global::Leonardo.DeleteElementByIdResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Leonardo.DeleteElementByIdResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
