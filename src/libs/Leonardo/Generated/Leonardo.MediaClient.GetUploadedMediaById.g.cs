...
namespace Leonardo
{
    public partial class MediaClient
    {
        ...
        private static readonly global::Leonardo.EndPointSecurityRequirement s_GetUploadedMediaByIdSecurityRequirement0 =
        ...
        private static readonly global::Leonardo.EndPointSecurityRequirement[] s_GetUploadedMediaByIdSecurityRequirements =
            new global::Leonardo.EndPointSecurityRequirement[]
            {                s_GetUploadedMediaByIdSecurityRequirement0,
            };
        partial void PrepareGetUploadedMediaByIdArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id);
        partial void PrepareGetUploadedMediaByIdRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id);
        partial void ProcessGetUploadedMediaByIdResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetUploadedMediaByIdResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Leonardo.GetUploadedMediaByIdResponse> GetUploadedMediaByIdAsync(
            string id,
            global::Leonardo.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetUploadedMediaByIdAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Leonardo.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Leonardo.AutoSDKHttpResponse<global::Leonardo.GetUploadedMediaByIdResponse>> GetUploadedMediaByIdAsResponseAsync(
            string id,
            global::Leonardo.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetUploadedMediaByIdArguments(
            ...
            var __authorizations = global::Leonardo.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetUploadedMediaByIdSecurityRequirements,
                operationName: "GetUploadedMediaByIdAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetUploadedMediaByIdRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Leonardo.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Leonardo.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetUploadedMediaByIdAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetUploadedMediaByIdResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Leonardo.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetUploadedMediaByIdResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Leonardo.GetUploadedMediaByIdResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Leonardo.AutoSDKHttpResponse<global::Leonardo.GetUploadedMediaByIdResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Leonardo.GetUploadedMediaByIdResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
