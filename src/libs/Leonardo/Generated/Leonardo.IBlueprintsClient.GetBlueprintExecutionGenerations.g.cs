...
namespace Leonardo
{
    public partial interface IBlueprintsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Leonardo.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Leonardo.AutoSDKHttpResponse<global::Leonardo.GetBlueprintExecutionGenerationsResponse>> GetBlueprintExecutionGenerationsAsResponseAsync(
            string? id,
            int? first = default,
            string? after = default,
            int? last = default,
