...
namespace Leonardo
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Leonardo.AutoSDKRetryOptions Retry { get; set; } = new global::Leonardo.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Leonardo.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Leonardo.IAutoSDKHook>();
        ...
        public global::Leonardo.AutoSDKClientOptions AddHook(
            global::Leonardo.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Leonardo.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Leonardo.AutoSDKClientOptions UseAuthorizationProvider(
            global::Leonardo.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Leonardo.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Leonardo.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Leonardo.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Leonardo.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Leonardo.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Leonardo.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Leonardo.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Leonardo.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Leonardo.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Leonardo.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Leonardo.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Leonardo.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Leonardo.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Leonardo.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Leonardo.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Leonardo.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Leonardo.AutoSDKClientOptions clientOptions,
            global::Leonardo.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Leonardo.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Leonardo.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Leonardo.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Leonardo.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Leonardo.IAutoSDKHook, global::Leonardo.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Leonardo.AutoSDKHookContext context)
        {
